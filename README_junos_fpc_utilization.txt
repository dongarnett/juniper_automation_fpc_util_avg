...
FPC 0 state is Online. Current CPU utilization is 32. Current memory utilization is 511MB, buffer use % is 0, and heap use % is 32.
Sending command: show chassis fpc

Interval 0
Sending command: show chassis fpc

FPC 0 CPU Utilization: 32%
...
FPC 0 CPU Utilization: 24%
FPC 0 CPU Utilization - Total Memory: 511MB
FPC 0 CPU Utilization - Memory Heap: 32%
FPC 0 CPU Utilization - Memory Buffer: 0%
########################################################
FPCs online in slots: ['0']
########################################################
################# FPC SLOT 0 SUMMARY ###################
########################################################
FPC CPU utilizations after 10x 1 second iterations:
########################################################
FPC 0 CPU Utilization (Maximum): 32%
FPC 0 CPU Utilization (Average): 30.18%
